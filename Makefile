...
ifeq "$(CFG)" "Debug"
OUTDIR=Debug
OUTFILE=$(OUTDIR)/cgroup-statd
CFG_INC=-I/usr/include/dlt 
CFG_LIB=-ldlt 
CFG_OBJ=
COMMON_OBJ=$(OUTDIR)/cgroup-statd.o 
OBJ=$(COMMON_OBJ) $(CFG_OBJ)
ALL_OBJ=$(OUTDIR)/cgroup-statd.o -ldlt 
...
OUTDIR=Release
OUTFILE=$(OUTDIR)/cgroup-statd
CFG_INC=-I/usr/include/dlt -I/usr/include 
CFG_LIB=-ldlt 
CFG_OBJ=
COMMON_OBJ=$(OUTDIR)/cgroup-statd.o 
OBJ=$(COMMON_OBJ) $(CFG_OBJ)
